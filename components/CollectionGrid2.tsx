...
export default function CollectionGrid2() {
			...
			{data => {
				...
				return (
					<Animation animation={fadeIn}>
						<StyledCollectionGrid className="flex">
							<BackgroundImage
							...
							>
								<div className="inner flex align-center justify-center flex-column h-full w-full">
									<Heading as="h1" size="medium" fontWeight={600} className="collection-heading">
										Collections
									</Heading>
								...
								{data.collections.edges.map((product, index) => {
									...
									return (
										...
										>
											...
											/>
											<div className="collection-name absolute w-full h-full top-0 left-0 flex align-center justify-center">
												{product.node.title}
											</div>
											>
										</div>
